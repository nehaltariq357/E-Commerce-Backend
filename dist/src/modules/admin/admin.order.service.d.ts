...
import type { UpdateOrderStatusInput } from "./admin.order.types.js";
...
export declare const updateOrderStatusService: (orderId: number, data: UpdateOrderStatusInput) => Promise<{
    id: number;
    createdAt: Date;
    updatedAt: Date;
    userId: number;
...
//# sourceMappingURL=admin.order.service.d.ts.map