...
export const getCart = async (req, res) => {
    try {
        ...
        return res.status(404).json({
            success: false,
            message: error instanceof Error ? error.message : "Cart not found",
        });
    }
};
export const updateCartItem = async (req, res) => {
    try {
        ...
        const cartItem = await updateCartItemService(req.user.userId, cartItemId, data.quantity);
        return res.status(200).json({
            success: true,
...
export const removeCartItem = async (req, res) => {
    try {
        ...
        await removeCartItemService(req.user.userId, cartItemId);
        return res.status(200).json({
            success: true,
