...
import { createProduct, getallproduct, findproductbyid, updateproduct, deleteproduct, addProductImage, addProductVarient, getProductVariant, updateProductVariant, deleteProductVariant, } from "./product.controller.js";
...
router.patch("/variants/:id", authenticate, requireRole("ADMIN"), updateProductVariant);
