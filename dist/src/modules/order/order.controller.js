...
export const createOrder = async (req, res) => {
    try {
        ...
        // Create order
        const order = await createOrderService(req.user.userId, data);
...
export const getMyOrderById = async (req, res) => {
    try {
        ...
        const order = await getMyOrderByIdService(orderId, req.user.userId);
        return res.status(200).json({
            success: true,
...
export const cancelOrder = async (req, res) => {
    try {
        ...
        const order = await cancelOrderService(req.user.userId, orderId);
        return res.status(200).json({
            success: true,
...
export const updateOrderStatus = async (req, res) => {
    try {
        ...
        const order = await updateOrderStatusService(orderId, data.status);
        return res.status(200).json({
            success: true,
