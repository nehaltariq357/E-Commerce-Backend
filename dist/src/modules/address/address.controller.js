import { createAddressService, getAddressesService, getAddressByIdService, updateAddressService, deleteAddressService, } from "./address.service.js";
...
export const updateAddress = async (req, res) => {
    try {
        ...
        const address = await updateAddressService(req.user.userId, addressId, data);
        return res.status(200).json({
            success: true,
