...
export const addToCartService = async (userId: number, input: addToCartInput) => {
    // check product
...
export const updateCartItemService = async (
  ...
  const cartItem = await findCartItemByIdAndUserId(
    cartItemId,
    userId
  );
...
export const removeCartItemService = async (
  ...
  const cartItem = await findCartItemByIdAndUserIdDelete(
    cartItemId,
    userId
  );
